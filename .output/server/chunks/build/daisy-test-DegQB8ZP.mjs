...
import { ref, unref, mergeProps, withCtx, createTextVNode, openBlock, createBlock, createVNode, renderSlot, useSSRContext } from 'vue';
          ...
          if (_push2) {
            ...
            return [
              (openBlock(), createBlock("svg", {
                ...
                createVNode("path", { d: "M10 0C4.612 0 0 5.336 0 7c0 1.742 3.546 7 10 7 6.454 0 10-5.258 10-7 0-1.664-4.612-7-10-7Zm0 10a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z" })
              ])),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.show) {
        ...
        _push(ssrRenderComponent(_component_ViewMoreButton, { to: "/contact" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Contact me`);
            } else {
...
//# sourceMappingURL=daisy-test-DegQB8ZP.mjs.map
