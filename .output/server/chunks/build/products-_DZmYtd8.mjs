import { resolveComponent, withCtx, createTextVNode, createVNode, ref, defineComponent, inject, reactive, provide, getCurrentInstance, mergeProps, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_0 } from './nuxt-link-C85iBeMR.mjs';
import './server.mjs';
import 'node:http';
import 'node:https';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs, _cssVars))} data-v-ab53f376><div class="card" data-v-ab53f376><div class="front" data-v-ab53f376>`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
              ...
              _push3(ssrRenderComponent(_component_Title, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    return [
                      createTextVNode("Product to help developers in their work")
                    ];
                  }
                }),
                _: 1
  ...
  _push(ssrRenderComponent(_component_v_row, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_v_col, { class: "text-left" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(ssrRenderComponent(_component_GlassmorphCard, { height: "200px" }, {
                  ...
                  if (_push4) {
                    ...
                    return [
                      createVNode("div", {
                        ...
                        createVNode("div", null, [
                          createVNode("span", null, "Model based code generator.")
                        ])
                      ])
                    ];
                  }
                  ...
                  if (_push4) {
                    ...
                    return [
                      createVNode("div", {
                        ...
                        createVNode("div", null, [
                          createVNode("span", null, "Continuous Integration solution.")
                        ])
                      ])
                    ];
                  }
              ...
              _push3(ssrRenderComponent(_component_GlassmorphCard, { height: "200px" }, {
                front: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(ssrRenderComponent(_component_NuxtLink, { to: "/color-tools" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`Palette Generator`);
                        } else {
                          return [
                            createTextVNode("Palette Generator")
                          ];
                        }
                      }),
                      _: 1
                    ...
                    return [
                      createVNode("div", null, [
                        createVNode("div", { class: "pa-4" }, [
                          createVNode("div", null, [
                            createVNode("h2", null, [
                              createVNode(_component_NuxtLink, { to: "/color-tools" }, {
                                default: withCtx(() => [
                                  createTextVNode("Palette Generator")
                                ]),
                                _: 1
                          ...
                          createVNode("div", null, [
                            createVNode("span", null, "Harmonic Colors Palette generator.")
                          ])
                        ])
                      ])
                    ];
              ...
              _push3(ssrRenderComponent(_component_GlassmorphCard, { height: "200px" }, {
                front: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div data-v-664c2a68${_scopeId3}><div class="pa-4" data-v-664c2a68${_scopeId3}><div data-v-664c2a68${_scopeId3}><h2 data-v-664c2a68${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_NuxtLink, { to: "/utm-builder" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`Utm url builder`);
                        } else {
                          return [
                            createTextVNode("Utm url builder")
                          ];
                        }
                      }),
                      _: 1
                    ...
                    return [
                      createVNode("div", null, [
                        createVNode("div", { class: "pa-4" }, [
                          createVNode("div", null, [
                            createVNode("h2", null, [
                              createVNode(_component_NuxtLink, { to: "/utm-builder" }, {
                                default: withCtx(() => [
                                  createTextVNode("Utm url builder")
                                ]),
                                _: 1
                          ...
                          createVNode("div", null, [
                            createVNode("span", null, "This tool helps create Utm urls for ad campaigns.")
                          ])
                        ])
                      ])
                    ];
              ...
              return [
                createVNode("h1", null, "Products"),
                createVNode("p", null, [
                  createTextVNode(" Did you find a bug? Report it here "),
                  createVNode("a", {
                ...
                createVNode("div", { class: "d-flex flex-wrap ma-8 background" }, [
                  createVNode("div", { class: "pa-4" }, [
                    createVNode(_component_GlassmorphCard, { height: "200px" }, {
                      front: withCtx(() => [
                        createVNode("div", {
                          class: "pa-4",
                          transition: "fab-transition"
...
//# sourceMappingURL=products-_DZmYtd8.mjs.map
