...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "palette-show" }, _attrs, _cssVars))} data-v-ac9b2fac><section data-v-ac9b2fac><h1 data-v-ac9b2fac>Harmonic Colors Palette </h1>`);
...
//# sourceMappingURL=color-tools-CwDRwhRK.mjs.map
