...
import { useSSRContext, resolveComponent, mergeProps, withCtx, createTextVNode, openBlock, createBlock, toDisplayString, createVNode } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_v_app, mergeProps({ dark: "" }, _attrs), {
...
//# sourceMappingURL=error-Cizb8uMP.mjs.map
