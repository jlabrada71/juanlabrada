import { c as C, s as vt, g as Ct, a as Ot, b as Pt, C as At, D as Gt, l as B, j as D, E as It, h as St, A as Nt, H as Ht, I as Bt } from "./entry-B7RwYlCB.js";
var mt = function() {
  var r = function(G, o, u, d) {
    ...
    parse: function(o) {
      ...
      function Mt() {
        var q;
        return q = s.pop() || O.lex() || pt, typeof q != "number" && (q instanceof Array && (s = q, q = s.pop()), q = u.symbols_[q] || q), q;
      }
        ...
        switch (V[0]) {
          ...
          case 2:
            if (j = this.productions_[V[1]][1], J.$ = T[T.length - j], J._$ = {
              ...
              return lt;
            j && (d = d.slice(0, -1 * j * 2), T = T.slice(0, -1 * j), t = t.slice(0, -1 * j)), d.push(this.productions_[V[1]][0]), T.push(J.$), t.push(J._$), bt = X[d[d.length - 2]][d[d.length - 1]], d.push(bt);
            break;
          case 3:
            return !0;
        }
...
mt.parser = mt;
const Vt = mt;
let at = C().gitGraph.mainBranchName, Dt = C().gitGraph.mainBranchOrder, v = {}, S = null, tt = {};
...
const qt = function(r) {
  ...
  S = i, v[i.id] = i, L[A] = i.id, B.debug("in pushCommit " + i.id);
}, Kt = function(r, n) {
  if (r = D.sanitizeText(r, C()), L[r] === void 0)
    L[r] = S != null ? S.id : null, tt[r] = { name: r, order: n ? parseInt(n, 10) : null }, yt(r), B.debug("in createBranch");
  else {
    let l = new Error(
  ...
  S = p, v[p.id] = p, L[A] = p.id, B.debug(L), B.debug("in mergeBranch");
}, Wt = function(r, n, l, h) {
  ...
  if (!n || v[n] === void 0) {
    ...
    S = m, v[m.id] = m, L[A] = m.id, B.debug(L), B.debug("in cherryPick");
  }
}, yt = function(r) {
  if (r = D.sanitizeText(r, C()), L[r] === void 0) {
    let n = new Error(
...
const Jt = function() {
  ...
  L = {}, L[r] = null, tt = {}, tt[r] = { name: r, order: n }, A = r, W = 0, It();
}, Xt = function() {
