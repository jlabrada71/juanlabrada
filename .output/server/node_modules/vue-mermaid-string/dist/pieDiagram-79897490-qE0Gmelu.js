import { V as H, W as at, C as lt, D as ot, s as ct, g as ht, b as ut, a as yt, E as ft, d as pt, c as et, l as it, X as gt, U as dt, Y as mt, i as _t } from "./entry-B7RwYlCB.js";
import { a as tt } from "./arc-oW-7rLnL.js";
import { o as xt } from "./ordinal-MUacOSdK.js";
import { a as kt } from "./array-CqVTtuYm.js";
import { c as F } from "./path-Crsf9Nsj.js";
function vt(e, u) {
...
function St() {
  var e = bt, u = vt, $ = null, p = F(0), g = F(H), E = F(0);
  function y(a) {
    var l, d = (a = kt(a)).length, m, I, T = 0, _ = new Array(d), v = new Array(d), c = +p.apply(this, arguments), A = Math.min(H, Math.max(-H, g.apply(this, arguments) - c)), O, w = Math.min(Math.abs(A) / d, E.apply(this, arguments)), b = w * (A < 0 ? -1 : 1), t;
    for (l = 0; l < d; ++l)
