import { g as we, D as ve, C as _e, c as st, s as $t, b as ke, a as Pe, E as Le, l as X, d as At, j as v, e as Ie, h as Lt, i as Ae, A as B, a4 as nt, a5 as wt, m as te, r as ee, _ as Bt, Y as se, a6 as Ne } from "./entry-B7RwYlCB.js";
import { d as Se, a as Me, g as Nt, b as zt, c as Re, e as Ce } from "./svgDrawCommon-5ccd53ef-BDAMkrwK.js";
var Yt = function() {
  var t = function(dt, w, k, L) {
    for (k = k || {}, L = dt.length; L--; k[dt[L]] = w)
      ;
    return k;
  }, e = [1, 2], c = [1, 3], s = [1, 4], i = [2, 4], a = [1, 9], o = [1, 11], l = [1, 13], p = [1, 14], r = [1, 16], x = [1, 17], T = [1, 18], u = [1, 24], g = [1, 25], m = [1, 26], _ = [1, 27], I = [1, 28], V = [1, 29], S = [1, 30], O = [1, 31], R = [1, 32], q = [1, 33], z = [1, 34], J = [1, 35], $ = [1, 36], H = [1, 37], U = [1, 38], F = [1, 39], W = [1, 41], Z = [1, 42], K = [1, 43], Q = [1, 44], tt = [1, 45], N = [1, 46], y = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], P = [4, 5, 16, 50, 52, 53], j = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 54, 59, 60, 61, 62, 70], rt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], A = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 54, 59, 60, 61, 62, 70], Gt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 54, 59, 60, 61, 62, 70], ht = [68, 69, 70], ot = [1, 120], Mt = {
    trace: function() {
    },
    yy: {},
...
const E = new Ve(() => ({
  ...
  if (a) {
    ...
    if (i = a.box ? a.box : E.records.currentBox, a.box = i, a && e === a.name && c == null)
      return;
  }
...
}, C = function(t, e, c = { text: void 0, wrap: void 0 }, s, i = !1) {
...
const oe = function(t, e) {
  const c = vt(t), s = document.getElementById(e.text);
  try {
    const i = s.innerHTML, a = JSON.parse(i);
    a.properties && ne(c, a.properties), a.links && Ht(c, a.links);
  } catch (i) {
...
`, o0 = n0, ft = 18 * 2, le = "actor-top", he = "actor-bottom", Ut = function(t, e) {
  ...
  i && (p = "block !important");
  const r = t.append("g");
  r.attr("id", "actor" + o + "_popup"), r.attr("class", "actorPopupMenu"), r.attr("display", p);
  var x = "";
...
}, It = async function(t, e, c = null) {
  let s = t.append("foreignObject");
  const i = await ee(e.text, Bt()), o = s.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(i).node().getBoundingClientRect();
  if (s.attr("height", Math.round(o.height)).attr("width", Math.round(o.width)), e.class === "noteText") {
    ...
    const p = l.getBBox();
    s.attr("x", Math.round(p.x + p.width / 2 - o.width / 2)).attr("y", Math.round(p.y + p.height / 2 - o.height / 2));
  } else if (c) {
    ...
    s.attr("x", Math.round(l + Math.abs(l - p) / 2 - o.width / 2)), e.class === "loopText" ? s.attr("y", Math.round(r)) : s.attr("y", Math.round(r - o.height));
  }
  return [s];
}, bt = function(t, e) {
  let c = 0, s = 0;
  const i = e.text.split(v.lineBreakRegex), [a, o] = se(e.fontSize);
  let l = [], p = 0, r = () => e.y;
  ...
  for (let [x, T] of i.entries()) {
    ...
    if (e.tspan) {
      ...
      u.text(g);
    e.valign !== void 0 && e.textMargin !== void 0 && e.textMargin > 0 && (s += (u._groups || u)[0][0].getBBox().height, c = s), l.push(u);
  }
  return l;
}, de = function(t, e) {
  function c(i, a, o, l, p) {
    return i + "," + a + " " + (i + o) + "," + a + " " + (i + o) + "," + (a + l - p) + " " + (i + o - p * 1.2) + "," + (a + l) + " " + i + "," + (a + l);
  }
...
let at = -1;
const pe = (t, e, c, s) => {
  t.select && c.forEach((i) => {
    const a = e[i], o = t.select("#actor" + a.actorCnt);
    !s.mirrorActors && a.stopy ? o.attr("y2", a.stopy + a.height / 2) : s.mirrorActors && o.attr("y2", a.stopy);
  });
}, h0 = async function(t, e, c, s) {
  const i = s ? e.stopy : e.starty, a = e.x + e.width / 2, o = i + 5, l = t.append("g").lower();
  var p = l;
  s || (at++, Object.keys(e.links || {}).length && !c.forceMenus && p.attr("onclick", l0(`actor${at}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + at).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line").attr("class", "200").attr("stroke-width", "0.5px").attr("stroke", "#999"), p = l.append("g"), e.actorCnt = at, e.links != null && p.attr("id", "root-" + at));
  const r = Nt();
  var x = "actor";
  ...
  const i = s ? e.stopy : e.starty, a = e.x + e.width / 2, o = i + 80;
  ...
  return e.height = T.height, await Kt(c, nt(e.description))(
    e.description,
    l,
    r.x,
    r.y + 35,
...
}, u0 = async function(t, e, c) {
  const i = t.append("g");
  ue(i, e), e.name && await Kt(c)(
    e.name,
    i,
    e.x,
  ...
  return t.append("g");
}, g0 = function(t, e, c, s, i) {
  const a = Nt(), o = e.anchored;
  a.x = e.startx, a.y = e.starty, a.class = "activation" + i % 3, a.width = e.stopx - e.startx, a.height = c - e.starty, Ut(o, a);
  ...
  function t(a, o, l, p, r, x, T) {
    const u = o.append("text").attr("x", l + r / 2).attr("y", p + x / 2 + 5).style("text-anchor", "middle").text(a);
    i(u, T);
  }
  function e(a, o, l, p, r, x, T, u) {
    const { actorFontSize: g, actorFontFamily: m, actorFontWeight: _ } = u, [I, V] = se(g), S = a.split(v.lineBreakRegex);
    for (let O = 0; O < S.length; O++) {
      const R = O * I - I * (S.length - 1) / 2, q = o.append("text").attr("x", l + r / 2).attr("y", p).style("text-anchor", "middle").style("font-size", V).style("font-weight", _).style("font-family", m);
  ...
  function c(a, o, l, p, r, x, T, u) {
    const g = o.append("switch"), _ = g.append("foreignObject").attr("x", l).attr("y", p).attr("width", r).attr("height", x).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
  ...
  async function s(a, o, l, p, r, x, T, u) {
    const g = await wt(a, Bt()), m = o.append("switch"), I = m.append("foreignObject").attr("x", l + r / 2 - g.width / 2).attr("y", p + x / 2 - g.height / 2).attr("width", g.width).attr("height", g.height).append("xhtml:div").style("height", "100%").style("width", "100%");
  ...
  function e(i, a, o, l, p, r, x, T) {
    ...
    for (let I = 0; I < _.length; I++) {
      const V = I * u - u * (_.length - 1) / 2, S = a.append("text").attr("x", o).attr("y", l).style("text-anchor", "start").style("font-size", u).style("font-weight", m).style("font-family", g);
      S.append("tspan").attr("x", o).attr("dy", V).text(_[I]), S.attr("y", l + r / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), s(S, x);
    }
  }
  function c(i, a, o, l, p, r, x, T) {
    const u = a.append("switch"), m = u.append("foreignObject").attr("x", o).attr("y", l).attr("width", p).attr("height", r).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    m.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), e(i, u, o, l, p, r, x, T), s(m, x);
  }
  function s(i, a) {
    for (const o in a)
...
const f = {
  ...
  updateBounds: function(t, e, c, s) {
    ...
    function o(l) {
      return function(r) {
        ...
        i.updateVal(r, "starty", e - x * n.boxMargin, Math.min), i.updateVal(r, "stopy", s + x * n.boxMargin, Math.max), i.updateVal(f.data, "startx", t - x * n.boxMargin, Math.min), i.updateVal(f.data, "stopx", c + x * n.boxMargin, Math.max), l !== "activation" && (i.updateVal(r, "startx", t - x * n.boxMargin, Math.min), i.updateVal(r, "stopx", c + x * n.boxMargin, Math.max), i.updateVal(f.data, "starty", e - x * n.boxMargin, Math.min), i.updateVal(f.data, "stopy", s + x * n.boxMargin, Math.max));
      };
    }
    this.sequenceItems.forEach(o()), this.activations.forEach(o("activation"));
  },
  insert: function(t, e, c, s) {
    const i = v.getMin(t, c), a = v.getMax(t, c), o = v.getMin(e, s), l = v.getMax(e, s);
  ...
  newActivation: function(t, e, c) {
    const s = c[t.from.actor], i = St(t.from.actor).length || 0, a = s.x + s.width / 2 + (i - 1) * n.activationWidth / 2;
  ...
  const s = t.append("g"), i = D.drawRect(s, c), a = zt();
  a.x = e.startx, a.y = e.starty, a.width = c.width, a.dy = "1em", a.text = e.message, a.class = "noteText", a.fontFamily = n.noteFontFamily, a.fontSize = n.noteFontSize, a.fontWeight = n.noteFontWeight, a.anchor = n.noteAlign, a.textMargin = n.noteMargin, a.valign = "center";
  const o = nt(a.text) ? await It(s, a) : bt(s, a), l = Math.round(
    o.map((p) => (p._groups || p)[0][0].getBBox().height).reduce((p, r) => p + r)
  );
  i.attr("height", l + 2 * n.noteMargin), e.height += l + 2 * n.noteMargin, f.bumpVerticalPos(l + 2 * n.noteMargin), e.stopy = e.starty + l + 2 * n.noteMargin, e.stopx = e.startx + c.width, f.insert(e.startx, e.starty, e.stopx, e.stopy), f.models.addNote(e);
}, xt = (t) => ({
...
async function L0(t, e) {
  ...
  const { startx: c, stopx: s, message: i } = e, a = v.splitBreaks(i).length, o = nt(i), l = o ? await wt(i, st()) : B.calculateTextDimensions(i, xt(n));
  if (!o) {
    const T = l.height / a;
...
const I0 = async function(t, e, c, s) {
  const { startx: i, stopx: a, starty: o, message: l, type: p, sequenceIndex: r, sequenceVisible: x } = e, T = B.calculateTextDimensions(l, xt(n)), u = zt();
  u.x = i, u.y = o + 10, u.width = a - i, u.class = "messageText", u.dy = "1em", u.text = l, u.fontFamily = n.messageFontFamily, u.fontSize = n.messageFontSize, u.fontWeight = n.messageFontWeight, u.anchor = n.messageAlign, u.valign = "center", u.textMargin = n.wrapPadding, u.tspan = !1, nt(u.text) ? await It(t, u, { startx: i, stopx: a, starty: c }) : bt(t, u);
  const g = T.width;
  let m;
  i === a ? n.rightAngles ? m = t.append("path").attr(
    ...
    "d",
    "M " + i + "," + c + " C " + (i + 60) + "," + (c - 10) + " " + (i + 60) + "," + (c + 30) + " " + i + "," + (c + 20)
  ) : (m = t.append("line"), m.attr("x1", i), m.attr("y1", c), m.attr("x2", a), m.attr("y2", c)), p === s.db.LINETYPE.DOTTED || p === s.db.LINETYPE.DOTTED_CROSS || p === s.db.LINETYPE.DOTTED_POINT || p === s.db.LINETYPE.DOTTED_OPEN ? (m.style("stroke-dasharray", "3, 3"), m.attr("class", "messageLine1")) : m.attr("class", "messageLine0");
  let _ = "";
  n.arrowMarkerAbsolute && (_ = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, _ = _.replace(/\(/g, "\\("), _ = _.replace(/\)/g, "\\)")), m.attr("stroke-width", 2), m.attr("stroke", "none"), m.style("fill", "none"), (p === s.db.LINETYPE.SOLID || p === s.db.LINETYPE.DOTTED) && m.attr("marker-end", "url(" + _ + "#arrowhead)"), (p === s.db.LINETYPE.SOLID_POINT || p === s.db.LINETYPE.DOTTED_POINT) && m.attr("marker-end", "url(" + _ + "#filled-head)"), (p === s.db.LINETYPE.SOLID_CROSS || p === s.db.LINETYPE.DOTTED_CROSS) && m.attr("marker-end", "url(" + _ + "#crosshead)"), (x || n.showSequenceNumbers) && (m.attr("marker-start", "url(" + _ + "#sequencenumber)"), t.append("text").attr("x", i).attr("y", c + 4).attr("font-family", "sans-serif").attr("font-size", "12px").attr("text-anchor", "middle").attr("class", "sequenceNumber").text(r));
}, A0 = async function(t, e, c, s, i, a, o) {
  let l = 0, p = 0, r, x = 0;
  for (const T of s) {
    const u = e[T], g = u.box;
    r && r != g && (o || f.models.addBox(r), p += n.boxMargin + r.margin), g && g != r && (o || (g.x = l + p, g.y = i), p += g.margin), u.width = u.width || n.width, u.height = v.getMax(u.height || n.height, n.height), u.margin = u.margin || n.actorMargin, x = v.getMax(x, u.height), c[u.name] && (p += u.width / 2), u.x = l + p, u.starty = f.getVerticalPos(), f.insert(u.x, i, u.x + u.width, u.height), l += u.width + p, u.box && (u.box.width = l + g.margin - u.box.x), p = u.margin, r = u.box, f.models.addActor(u);
  }
  ...
  if (s) {
    ...
    for (const a of c) {
      ...
      const l = await D.drawActor(t, o, n, !0);
      i = v.getMax(i, l);
    }
  ...
  let i = 0, a = 0;
  for (const o of c) {
    const l = e[o], p = R0(l), r = D.drawPopup(
      t,
      l,
      p,
      n,
  ...
  const c = e[t], s = St(t), i = s.reduce(function(o, l) {
...
function it(t, e, c, s, i) {
  f.bumpVerticalPos(c);
  let a = s;
  if (e.id && e.message && t[e.id]) {
    const o = t[e.id].width, l = xt(n);
    e.message = B.wrapLabel(`[${e.message}]`, o - 2 * n.wrapPadding, l), e.width = o, e.wrap = !0;
...
const S0 = async function(t, e, c, s) {
  ...
  let o;
  i === "sandbox" && (o = Lt("#i" + e));
  const l = i === "sandbox" ? Lt(o.nodes()[0].contentDocument.body) : Lt("body"), p = i === "sandbox" ? o.nodes()[0].contentDocument : document;
  f.init(), X.debug(s.db);
  ...
  I && r.append("text").text(I).attr("x", (W.stopx - W.startx) / 2 - 2 * n.diagramMarginX).attr("y", -25), Ae(r, K, tt, n.useMaxWidth);
  const N = I ? 40 : 0;
  r.attr(
    "viewBox",
...
async function M0(t, e, c) {
  ...
  for (const i of e)
    if (t[i.to] && t[i.from]) {
      const a = t[i.to];
      if (i.placement === c.db.PLACEMENT.LEFTOF && !a.prevActor || i.placement === c.db.PLACEMENT.RIGHTOF && !a.nextActor)
        continue;
      const o = i.placement !== void 0, l = !o, p = o ? Tt(n) : xt(n), r = i.wrap ? B.wrapLabel(i.message, n.width - 2 * n.wrapPadding, p) : i.message, T = (nt(r) ? await wt(i.message, st()) : B.calculateTextDimensions(r, p)).width + 2 * n.wrapPadding;
      l && i.from === a.nextActor ? s[i.to] = v.getMax(
        ...
        s[i.to] || 0,
        T / 2
      )) : i.placement === c.db.PLACEMENT.RIGHTOF ? s[i.from] = v.getMax(
        s[i.from] || 0,
        T
      ) : i.placement === c.db.PLACEMENT.LEFTOF ? s[a.prevActor] = v.getMax(
        s[a.prevActor] || 0,
        T
      ) : i.placement === c.db.PLACEMENT.OVER && (a.prevActor && (s[a.prevActor] = v.getMax(
        s[a.prevActor] || 0,
        T / 2
...
const R0 = function(t) {
  ...
  for (const s in t.links) {
    const a = B.calculateTextDimensions(s, c).width + 2 * n.wrapPadding + 2 * n.boxMargin;
    e < a && (e = a);
  }
  return e;
};
async function C0(t, e, c) {
  ...
  for (const a of Object.keys(t)) {
    ...
    const l = nt(o.description) ? await wt(o.description, st()) : B.calculateTextDimensions(o.description, Wt(n));
    o.width = o.wrap ? n.width : v.getMax(n.width, l.width + 2 * n.wrapPadding), o.height = o.wrap ? v.getMax(l.height, n.height) : n.height, s = v.getMax(s, o.height);
  }
  for (const a in e) {
    const o = t[a];
    if (!o)
    ...
    if (!l) {
      const T = e[a] + n.actorMargin - o.width / 2;
      o.margin = v.getMax(T, n.actorMargin);
      continue;
    }
    const r = e[a] + n.actorMargin - o.width / 2 - l.width / 2;
  ...
  return c.forEach((a) => {
    ...
    l -= 2 * n.boxTextMargin, a.wrap && (a.name = B.wrapLabel(a.name, l - 2 * n.wrapPadding, o));
    const p = B.calculateTextDimensions(a.name, o);
  ...
  }), c.forEach((a) => a.textMaxHeight = i), v.getMax(s, n.height);
}
const D0 = async function(t, e, c) {
  const s = e[t.from].x, i = e[t.to].x, a = t.wrap && t.message;
  let o = nt(t.message) ? await wt(t.message, st()) : B.calculateTextDimensions(
  ...
  return t.placement === c.db.PLACEMENT.RIGHTOF ? (l.width = a ? v.getMax(n.width, o.width) : v.getMax(
    e[t.from].width / 2 + e[t.to].width / 2,
    o.width + 2 * n.noteMargin
  ), l.startx = s + (e[t.from].width + n.actorMargin) / 2) : t.placement === c.db.PLACEMENT.LEFTOF ? (l.width = a ? v.getMax(n.width, o.width + 2 * n.noteMargin) : v.getMax(
    e[t.from].width / 2 + e[t.to].width / 2,
    o.width + 2 * n.noteMargin
  ), l.startx = s - l.width + (e[t.from].width - n.actorMargin) / 2) : t.to === t.from ? (o = B.calculateTextDimensions(
    a ? B.wrapLabel(
      t.message,
  ...
  if (![
    ...
    return {};
  const [s, i] = jt(t.from, e), [a, o] = jt(t.to, e), l = s <= a, p = l ? i : s;
  let r = l ? a : o;
  const x = Math.abs(a - o) > 2, T = (_) => l ? -_ : _;
  t.from === t.to ? r = p : (t.activate && !x && (r += T(n.activationWidth / 2 - 1)), [c.db.LINETYPE.SOLID_OPEN, c.db.LINETYPE.DOTTED_OPEN].includes(t.type) || (r += T(3)));
  const u = [s, i, a, o], g = Math.abs(p - r);
  ...
  for (const r of t) {
    ...
    r.placement !== void 0 ? (l = await D0(r, e, s), r.noteModel = l, a.forEach((T) => {
      o = T, o.from = v.getMin(o.from, l.startx), o.to = v.getMax(o.to, l.startx + l.width), o.width = v.getMax(o.width, Math.abs(o.from - o.to)) - n.labelBoxWidth;
      ...
      if (o = T, p.startx === p.stopx) {
        ...
        o.from = v.getMin(p.startx, o.from), o.to = v.getMax(p.stopx, o.to), o.width = v.getMax(o.width, p.width) - n.labelBoxWidth;
    }));
  }
