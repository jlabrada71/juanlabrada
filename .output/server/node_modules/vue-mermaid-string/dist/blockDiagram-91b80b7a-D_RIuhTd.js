import { c as _e, _ as se, h as H, i as Ee, l as S, E as ye, B as we, o as De } from "./entry-B7RwYlCB.js";
import { c as ve } from "./clone-CGh6WKAa.js";
import { i as Ne, c as ke, b as Ie, d as Oe, a as he, p as Te } from "./edges-d32062c0-DFJTYgXq.js";
import { G as ze } from "./graph-CpM6wUBG.js";
import { o as Ce } from "./ordinal-MUacOSdK.js";
import { c as Ae } from "./channel-CDTexOr5.js";
import { s as Re } from "./Tableau10-GLA_9iAD.js";
...
const Ye = () => {
  S.debug("Clear called"), ye(), U = { id: "root", type: "composite", children: [], columns: -1 }, O = { root: U }, re = [], j = {}, ie = [], V = {};
};
function We(e) {
...
function fe(e, a, d = !1) {
  ...
  const E = De((l == null ? void 0 : l.styles) || []), T = l.label, v = l.size || { width: 0, height: 0, x: 0, y: 0 };
  return {
...
const gt = function(e, a) {
  ...
  await lt(N, E, l);
  const y = ht(l);
  if (await ot(N, E, l), await ct(N, v, T, l, a), y) {
